# -*- coding: utf-8 -*-
#
# orion.algo.skopt documentation build configuration file.
#
...
import orion.algo.skopt as algo_plugin
...
latex_documents = [
    (
        master_doc,
        "orion.algo.skopt.tex",
        u"Oríon algo skopt Documentation",
...
man_pages = [
    (master_doc, "projectname", u"Oríon algo skopt Documentation", [author], 1)
]
